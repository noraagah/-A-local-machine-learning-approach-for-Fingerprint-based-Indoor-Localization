...
[CNN_Floor_Prediction] = CNN_Floor_Prediction_1208(Floor_train,Floor_test);
%[CNN_Floor_Prediction] = CNN_Floor_Prediction(Floor_Train, Floor_Test, m2-4);
CNN_Accuracy(s) = Classification_Accuracy(CNN_Floor_Prediction, Floor_test(:, m2-1))
