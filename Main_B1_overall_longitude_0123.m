%File Name: Main_B1_overall_longitude_0123
%Description: This file is for identifying the longitude and latitude of all the 307 observations
%in Building 1 in the validation sample by using a neural network.
...
Loc_test  = Data1.location_test_df(Data1.location_test_df(:, 316) == 1, :);
