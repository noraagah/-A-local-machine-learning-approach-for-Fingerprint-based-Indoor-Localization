%File Name: Loc_Train_RSSI_Image_Generation
...
function Loc_Train_RSSI_Image_Generation(Observations, Image_Locations, Image_numNeighbors, WAP_Predictions, Num_Points, folder_name)
        ...
        %the grid
        Idx = knnsearch(WAP_Predictions(:, 1:3), Image_Locations, 'k', Image_numNeighbors);
        ...
        for i = 1:size(Observations, 1)
            ...
            input_temp = RSSI_Image_Matrix_Temp(:,1:4);
            input_temp = input_temp(:,1:4);
            

%             input_temp = RSSI_Image_Matrix_Temp(RSSI_Image_Matrix_Temp(:, 4) == 1, 1:5);
