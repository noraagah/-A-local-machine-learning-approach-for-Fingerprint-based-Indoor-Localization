...
function [RSSI_Predictions] = RSSI_Prediction_HX(RSSI_Data, Location_Matrix)
    ...
    RSSI_Predictions_byproduct = ones(Num_Locs, Num_RSSIs);
    ...
    for k = 1:Num_RSSIs
        ...
        for j = 1:Num_Locs
            ...
            RSSI_Predictions(j, k) = ((top+ee)/bottom);
            RSSI_Predictions_byproduct(j, k) = bottom;
