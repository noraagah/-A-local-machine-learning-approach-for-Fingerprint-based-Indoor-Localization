%File Name: Main_B1_1222
%Description: This file is for identifying the floor of all 307 observations 
%in Building 1 in the validation sample by using neural network algorithms:
...
Floor_train_21 = Data1.location_train_df(Data1.location_train_df(:, 316) == 1, :);
Floor_train_21 = Floor_train_21(Floor_train_21(:, 315) >= 2, :);
Floor_test_21  = Data1.location_test_df(Data1.location_test_df(:, 316) == 1, :);
Floor_test_21  = Floor_test_21(CNN_Floor_Prediction==1,:);

Floor_train_20 = Data1.location_train_df(Data1.location_train_df(:, 316) == 1, :);
Floor_train_20 = Floor_train_20(Floor_train_20(:, 315) < 2, :);
Floor_test_20  = Data1.location_test_df(Data1.location_test_df(:, 316) == 1, :);
