%File Name: Main_B2_longitude_0118
%Description: This file is for identifying the longitude and latitude of all
%the 268 observations in Building 0 in the validation sample by (1) using a 
%neural network to determine whether observations belong to up/lower level 
%floors and then (2) using a neural network to identify longitude and latitude.
%(1) calls CNN_Floor_Prediction_1211.m and (2) calls CNN_Loc_Prediction_1111.m
%and CNN_Loc_Prediction_0124.m for network training and prediction.
%Inputs: None
%Outputs: None
...
Loc_test_20  = Floor_test(CNN_Floor_Prediction==0,:);
 ...
 [CNN_Loc_Prediction_20] = CNN_Loc_Prediction_0111(Loc_train_20, Loc_test_20);
 [CNN_Loc_Prediction_21] = CNN_Loc_Prediction_0124(Loc_train_21, Loc_test_21);
