%File Name: Main_longitude_overall_0118
%Description: This file is for identifying the longitude and latitude of all the 1111
%observations in the validation sample by using a neural network. 
%The file calls CNN_Loc_Prediction_0117m for network training and prediction.
%Inputs: None
%Outputs: None
...
Loc_train = Data1.location_train_df(:, :);
n =length(Loc_train);
...
Floor_test  = Data1.location_test_df(:, :);
...
Loc_train = [Floor_train(:,test_index1<n_trim), Floor_train(:,m2-3:m2)];
Loc_test  = [Floor_test(:,test_index1<n_trim),  Floor_test(:,m2-3:m2)];
...
[CNN_Loc_Prediction] = CNN_Loc_Prediction_0117(Loc_train, Loc_test);
...
Loc_test0 = Loc_test(Loc_test(:,size(Loc_test,2)-1)==0,:); 
Loc_test1 = Loc_test(Loc_test(:,size(Loc_test,2)-1)==1,:); 
Loc_test2 = Loc_test(Loc_test(:,size(Loc_test,2)-1)==2,:);
CNN_Loc_Prediction0 = CNN_Loc_Prediction (Loc_test(:,size(Loc_test,2)-1)==0,:);
CNN_Loc_Prediction1 = CNN_Loc_Prediction (Loc_test(:,size(Loc_test,2)-1)==1,:);
CNN_Loc_Prediction2 = CNN_Loc_Prediction (Loc_test(:,size(Loc_test,2)-1)==2,:);

True_vals0 =  [Loc_test0(:, size(Loc_test0,2)-3), Loc_test0(:, size(Loc_test0,2)-2)];
[Mean0(s), Median0(s) , STD0(s), Min0(s), Max0(s), Quartiles0(s:s+2)] = Regression_Accuracy(CNN_Loc_Prediction0, True_vals0);
True_vals1 =  [Loc_test1(:, size(Loc_test1,2)-3), Loc_test1(:, size(Loc_test1,2)-2)];
[Mean1(s), Median1(s) , STD1(s), Min1(s), Max1(s), Quartiles1(s:s+2)] = Regression_Accuracy(CNN_Loc_Prediction1, True_vals1);
True_vals2 =  [Loc_test2(:, size(Loc_test2,2)-3), Loc_test2(:, size(Loc_test2,2)-2)];
[Mean2(s), Median2(s) , STD2(s), Min2(s), Max2(s), Quartiles2(s:s+2)] = Regression_Accuracy(CNN_Loc_Prediction2, True_vals2);
