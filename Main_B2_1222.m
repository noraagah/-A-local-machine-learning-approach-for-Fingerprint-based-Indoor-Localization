%File Name: Main_B2_1222
%Description: This file is for identifying the floor of all 268 observations 
%in Building 2 in the validation sample by using neural network algorithms:
%it first identifies upper/lower floors (01 versus 234), and then uses two 
%neural network algorithms to identify floors for observations belonging to 
%upper/lower floors respectively. This file calls CNN_Floor_Prediction_1209.m
...
Floor_train_21 = Data1.location_train_df(Data1.location_train_df(:, 316) == 2, :);
Floor_train_21 = Floor_train_21(Floor_train_21(:, 315) >= 2, :);
Floor_test_21  = Data1.location_test_df(Data1.location_test_df(:, 316) == 2, :);
Floor_test_21  = Floor_test_21(CNN_Floor_Prediction==1,:);

Floor_train_20 = Data1.location_train_df(Data1.location_train_df(:, 316) == 2, :);
Floor_train_20 = Floor_train_20(Floor_train_20(:, 315) < 2, :);
Floor_test_20  = Data1.location_test_df(Data1.location_test_df(:, 316) == 2, :);
...
[CNN_Floor_Prediction_21] = CNN_Floor_Prediction_1209(Floor_train_21,Floor_test_21);
[CNN_Floor_Prediction_20] = CNN_Floor_Prediction_1209(Floor_train_20,Floor_test_20);


CNN_Floor_Prediction_21=4*(CNN_Floor_Prediction_21==2)+3*(CNN_Floor_Prediction_21==1)+2*(CNN_Floor_Prediction_21==0);
