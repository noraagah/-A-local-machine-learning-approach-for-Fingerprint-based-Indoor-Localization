...
hmap_build0 = ones(sqrt(Num_Points), 2);
%Building 0%Longitude from -7700 to -7580
...
Floor_RSSI_Image_Generation(Floor_Train_Temp(:, 1:312), Location_Matrix, Image_numNeighbors, WAP_Predictions, Num_Points, "Floor Training Images");
...
Floor_RSSI_Image_Generation(Floor_Test_Temp(:, 1:312), Location_Matrix, Image_numNeighbors, WAP_Predictions, Num_Points, "Floor Test Images");
