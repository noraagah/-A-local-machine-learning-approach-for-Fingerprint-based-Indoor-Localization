%File Name: Main_B0_overall_longitude_0123
%Description: This file is for identifying the longitude and latitude of all the 536 observations
%in Building 0 in the validation sample by using a neural network. 
...
Loc_test  = Data1.location_test_df(Data1.location_test_df(:, 316) == 0, :);
